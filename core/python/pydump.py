...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:0AEA0220-0FBE-E711-A36C-A0369FD20608.root'),
...
process.NjettinessCa15SoftDropCHS = cms.EDProducer("NjettinessAdder",
    Njets = cms.vuint32(1, 2, 3),
    R0 = cms.double(1.5),
    Rcutoff = cms.double(999.0),
    akAxesR0 = cms.double(999.0),
...
process.ca15CHSJetsPruned = cms.EDProducer("FastjetJetProducer",
    Active_Area_Repeats = cms.int32(1),
    GhostArea = cms.double(0.01),
    Ghost_EtaMax = cms.double(5.0),
    Rho_EtaMax = cms.double(4.4),
...
process.ca15CHSJetsSoftDrop = cms.EDProducer("FastjetJetProducer",
    Active_Area_Repeats = cms.int32(1),
    GhostArea = cms.double(0.01),
    Ghost_EtaMax = cms.double(5.0),
    R0 = cms.double(1.5),
...
process.ca8CHSJetsPruned = cms.EDProducer("FastjetJetProducer",
    Active_Area_Repeats = cms.int32(1),
    GhostArea = cms.double(0.01),
    Ghost_EtaMax = cms.double(5.0),
    Rho_EtaMax = cms.double(4.4),
...
process.ca8PuppiJetsPruned = cms.EDProducer("FastjetJetProducer",
    Active_Area_Repeats = cms.int32(1),
    GhostArea = cms.double(0.01),
    Ghost_EtaMax = cms.double(5.0),
    Rho_EtaMax = cms.double(4.4),
...
process.patJetCorrFactorsAk8CHSJets = cms.EDProducer("JetCorrFactorsProducer",
    emf = cms.bool(False),
    extraJPTOffset = cms.string('L1FastJet'),
    flavorType = cms.string('J'),
    levels = cms.vstring('L1FastJet', 
...
process.patJetCorrFactorsAk8CHSJetsPruned = cms.EDProducer("JetCorrFactorsProducer",
    emf = cms.bool(False),
    extraJPTOffset = cms.string('L1FastJet'),
    flavorType = cms.string('J'),
    levels = cms.vstring('L1FastJet', 
    ...
    primaryVertices = cms.InputTag("offlineSlimmedPrimaryVertices"),
    rho = cms.InputTag("fixedGridRhoFastjetAll"),
    src = cms.InputTag("ak8CHSJetsPruned"),
    useNPV = cms.bool(True),
    useRho = cms.bool(True)
)


process.patJetCorrFactorsAk8CHSJetsPrunedSubjets = cms.EDProducer("JetCorrFactorsProducer",
    emf = cms.bool(False),
    extraJPTOffset = cms.string('L1FastJet'),
    flavorType = cms.string('J'),
    levels = cms.vstring('L1FastJet', 
    ...
    primaryVertices = cms.InputTag("offlineSlimmedPrimaryVertices"),
    rho = cms.InputTag("fixedGridRhoFastjetAll"),
    src = cms.InputTag("ak8CHSJetsPruned","SubJets"),
    useNPV = cms.bool(True),
    useRho = cms.bool(True)
)
...
process.patJetFlavourAssociationAk8CHSJets = cms.EDProducer("JetFlavourClustering",
    bHadrons = cms.InputTag("patJetPartons","bHadrons"),
    cHadrons = cms.InputTag("patJetPartons","cHadrons"),
    ghostRescaling = cms.double(1e-18),
    hadronFlavourHasPriority = cms.bool(False),
...
process.patJetFlavourAssociationAk8CHSJetsPruned = cms.EDProducer("JetFlavourClustering",
    bHadrons = cms.InputTag("patJetPartons","bHadrons"),
    cHadrons = cms.InputTag("patJetPartons","cHadrons"),
    ghostRescaling = cms.double(1e-18),
    hadronFlavourHasPriority = cms.bool(False),
    jetAlgorithm = cms.string('AntiKt'),
    jets = cms.InputTag("ak8CHSJetsPruned"),
    leptons = cms.InputTag("patJetPartons","leptons"),
    partons = cms.InputTag("patJetPartons","physicsPartons"),
    rParam = cms.double(0.8)
)
...
process.patJetFlavourAssociationAk8CHSJetsPrunedSubjets = cms.EDProducer("JetFlavourClustering",
    bHadrons = cms.InputTag("patJetPartons","bHadrons"),
    cHadrons = cms.InputTag("patJetPartons","cHadrons"),
    ghostRescaling = cms.double(1e-18),
    groomedJets = cms.InputTag("ak8CHSJetsPruned"),
    hadronFlavourHasPriority = cms.bool(False),
    jetAlgorithm = cms.string('AntiKt'),
    jets = cms.InputTag("ak8CHSJets"),
    leptons = cms.InputTag("patJetPartons","leptons"),
    partons = cms.InputTag("patJetPartons","physicsPartons"),
    rParam = cms.double(0.8),
    subjets = cms.InputTag("ak8CHSJetsPruned","SubJets")
)
...
process.patJetFlavourAssociationLegacyAk8CHSJets = cms.EDProducer("JetFlavourIdentifier",
    physicsDefinition = cms.bool(False),
    srcByReference = cms.InputTag("patJetPartonAssociationLegacyAk8CHSJets")
)


process.patJetFlavourAssociationLegacyAk8CHSJetsPruned = cms.EDProducer("JetFlavourIdentifier",
    physicsDefinition = cms.bool(False),
    srcByReference = cms.InputTag("patJetPartonAssociationLegacyAk8CHSJetsPruned")
)


process.patJetFlavourAssociationLegacyAk8CHSJetsPrunedSubjets = cms.EDProducer("JetFlavourIdentifier",
    physicsDefinition = cms.bool(False),
    srcByReference = cms.InputTag("patJetPartonAssociationLegacyAk8CHSJetsPrunedSubjets")
)
...
process.patJetGenJetMatchAk8CHSJets = cms.EDProducer("GenJetMatcher",
    checkCharge = cms.bool(False),
...
process.patJetGenJetMatchAk8CHSJetsPruned = cms.EDProducer("GenJetMatcher",
    checkCharge = cms.bool(False),
...
process.patJetGenJetMatchAk8CHSJetsPrunedSubjets = cms.EDProducer("GenJetMatcher",
    checkCharge = cms.bool(False),
...
process.patJetPartonAssociationLegacyAk8CHSJets = cms.EDProducer("JetPartonMatcher",
    coneSizeToAssociate = cms.double(0.3),
    jets = cms.InputTag("ak8CHSJets"),
    partons = cms.InputTag("patJetPartonsLegacy")
)
...
process.patJetPartonAssociationLegacyAk8CHSJetsPruned = cms.EDProducer("JetPartonMatcher",
    coneSizeToAssociate = cms.double(0.3),
    jets = cms.InputTag("ak8CHSJetsPruned"),
    partons = cms.InputTag("patJetPartonsLegacy")
)
...
process.patJetPartonAssociationLegacyAk8CHSJetsPrunedSubjets = cms.EDProducer("JetPartonMatcher",
    coneSizeToAssociate = cms.double(0.3),
    jets = cms.InputTag("ak8CHSJetsPruned","SubJets"),
    partons = cms.InputTag("patJetPartonsLegacy")
)
...
process.patJetPartonMatchAk8CHSJets = cms.EDProducer("MCMatcher",
    checkCharge = cms.bool(False),
    matched = cms.InputTag("prunedGenParticles"),
    maxDPtRel = cms.double(3.0),
    maxDeltaR = cms.double(0.4),
...
process.patJetPartonMatchAk8CHSJetsPruned = cms.EDProducer("MCMatcher",
    checkCharge = cms.bool(False),
    matched = cms.InputTag("prunedGenParticles"),
    maxDPtRel = cms.double(3.0),
    maxDeltaR = cms.double(0.4),
...
process.patJetPartonMatchAk8CHSJetsPrunedSubjets = cms.EDProducer("MCMatcher",
    checkCharge = cms.bool(False),
    matched = cms.InputTag("prunedGenParticles"),
    maxDPtRel = cms.double(3.0),
    maxDeltaR = cms.double(0.4),
...
process.patJetsAk8CHSJets = cms.EDProducer("PATJetProducer",
    JetFlavourInfoSource = cms.InputTag("patJetFlavourAssociationAk8CHSJets"),
    JetPartonMapSource = cms.InputTag("patJetFlavourAssociationLegacyAk8CHSJets"),
    addAssociatedTracks = cms.bool(False),
    ...
    discriminatorSources = cms.VInputTag(cms.InputTag("pfJetProbabilityBJetTagsAk8CHSJets"), cms.InputTag("pfJetBProbabilityBJetTagsAk8CHSJets"), cms.InputTag("pfSimpleSecondaryVertexHighEffBJetTagsAk8CHSJets"), cms.InputTag("pfCombinedInclusiveSecondaryVertexV2BJetTagsAk8CHSJets"), cms.InputTag("pfCombinedMVAV2BJetTagsAk8CHSJets"), 
        cms.InputTag("pfBoostedDoubleSecondaryVertexAK8BJetTagsAk8CHSJets"), cms.InputTag("pfBoostedDoubleSecondaryVertexCA15BJetTagsAk8CHSJets")),
    efficiencies = cms.PSet(
    ...
    embedGenPartonMatch = cms.bool(True),
    embedPFCandidates = cms.bool(False),
    genJetMatch = cms.InputTag("patJetGenJetMatchAk8CHSJets"),
    genPartonMatch = cms.InputTag("patJetPartonMatchAk8CHSJets"),
    getJetMCFlavour = cms.bool(True),
    jetChargeSource = cms.InputTag(""),
    jetCorrFactorsSource = cms.VInputTag(cms.InputTag("patJetCorrFactorsAk8CHSJets")),
    jetIDMap = cms.InputTag("ak4JetID"),
    jetSource = cms.InputTag("ak8CHSJets"),
    partonJetSource = cms.InputTag("NOT_IMPLEMENTED"),
    resolutions = cms.PSet(
    ...
    tagInfoSources = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8CHSJets"), cms.InputTag("pfSecondaryVertexTagInfosAk8CHSJets"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosAk8CHSJets"), cms.InputTag("softPFMuonsTagInfosAk8CHSJets"), cms.InputTag("softPFElectronsTagInfosAk8CHSJets"), 
        cms.InputTag("pfBoostedDoubleSVAK8TagInfosAk8CHSJets"), cms.InputTag("pfImpactParameterAK8TagInfosAk8CHSJets"), cms.InputTag("pfInclusiveSecondaryVertexFinderAK8TagInfosAk8CHSJets"), cms.InputTag("pfBoostedDoubleSVCA15TagInfosAk8CHSJets"), cms.InputTag("pfImpactParameterCA15TagInfosAk8CHSJets"), 
        cms.InputTag("pfInclusiveSecondaryVertexFinderCA15TagInfosAk8CHSJets")),
    trackAssociationSource = cms.InputTag(""),
    useLegacyJetMCFlavour = cms.bool(False),
    userData = cms.PSet(
        userCands = cms.PSet(
...
process.patJetsAk8CHSJetsPruned = cms.EDProducer("PATJetProducer",
    JetFlavourInfoSource = cms.InputTag("patJetFlavourAssociationAk8CHSJetsPruned"),
    JetPartonMapSource = cms.InputTag("patJetFlavourAssociationLegacyAk8CHSJetsPruned"),
    addAssociatedTracks = cms.bool(False),
    addBTagInfo = cms.bool(False),
    ...
    addResolutions = cms.bool(False),
    addTagInfos = cms.bool(True),
    discriminatorSources = cms.VInputTag(cms.InputTag("pfJetProbabilityBJetTagsAk8CHSJetsPruned"), cms.InputTag("pfJetBProbabilityBJetTagsAk8CHSJetsPruned"), cms.InputTag("pfSimpleSecondaryVertexHighEffBJetTagsAk8CHSJetsPruned"), cms.InputTag("pfCombinedInclusiveSecondaryVertexV2BJetTagsAk8CHSJetsPruned"), cms.InputTag("pfCombinedMVAV2BJetTagsAk8CHSJetsPruned"), 
        cms.InputTag("pfBoostedDoubleSecondaryVertexAK8BJetTagsAk8CHSJetsPruned"), cms.InputTag("pfBoostedDoubleSecondaryVertexCA15BJetTagsAk8CHSJetsPruned")),
    efficiencies = cms.PSet(
    ...
    embedGenPartonMatch = cms.bool(True),
    embedPFCandidates = cms.bool(False),
    genJetMatch = cms.InputTag("patJetGenJetMatchAk8CHSJetsPruned"),
    genPartonMatch = cms.InputTag("patJetPartonMatchAk8CHSJetsPruned"),
    getJetMCFlavour = cms.bool(False),
    jetChargeSource = cms.InputTag(""),
    jetCorrFactorsSource = cms.VInputTag(cms.InputTag("patJetCorrFactorsAk8CHSJetsPruned")),
    jetIDMap = cms.InputTag("ak4JetID"),
    jetSource = cms.InputTag("ak8CHSJetsPruned"),
    partonJetSource = cms.InputTag("NOT_IMPLEMENTED"),
    resolutions = cms.PSet(

    ),
    tagInfoSources = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8CHSJetsPruned"), cms.InputTag("pfSecondaryVertexTagInfosAk8CHSJetsPruned"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosAk8CHSJetsPruned"), cms.InputTag("softPFMuonsTagInfosAk8CHSJetsPruned"), cms.InputTag("softPFElectronsTagInfosAk8CHSJetsPruned"), 
        cms.InputTag("pfBoostedDoubleSVAK8TagInfosAk8CHSJetsPruned"), cms.InputTag("pfImpactParameterAK8TagInfosAk8CHSJetsPruned"), cms.InputTag("pfInclusiveSecondaryVertexFinderAK8TagInfosAk8CHSJetsPruned"), cms.InputTag("pfBoostedDoubleSVCA15TagInfosAk8CHSJetsPruned"), cms.InputTag("pfImpactParameterCA15TagInfosAk8CHSJetsPruned"), 
        cms.InputTag("pfInclusiveSecondaryVertexFinderCA15TagInfosAk8CHSJetsPruned")),
    trackAssociationSource = cms.InputTag(""),
    useLegacyJetMCFlavour = cms.bool(False),
    userData = cms.PSet(
        userCands = cms.PSet(
...
process.patJetsAk8CHSJetsPrunedPacked = cms.EDProducer("BoostedJetMerger",
    jetSrc = cms.InputTag("patJetsAk8CHSJetsPruned"),
    subjetSrc = cms.InputTag("patJetsAk8CHSJetsPrunedSubjets")
)


process.patJetsAk8CHSJetsPrunedSubjets = cms.EDProducer("PATJetProducer",
    JetFlavourInfoSource = cms.InputTag("patJetFlavourAssociationAk8CHSJetsPrunedSubjets","SubJets"),
    JetPartonMapSource = cms.InputTag("patJetFlavourAssociationLegacyAk8CHSJetsPrunedSubjets"),
    addAssociatedTracks = cms.bool(False),
    addBTagInfo = cms.bool(False),
    addDiscriminators = cms.bool(False),
    addEfficiencies = cms.bool(False),
    ...
    addResolutions = cms.bool(False),
    addTagInfos = cms.bool(True),
    discriminatorSources = cms.VInputTag(cms.InputTag("pfJetProbabilityBJetTagsAk8CHSJetsPrunedSubjets"), cms.InputTag("pfJetBProbabilityBJetTagsAk8CHSJetsPrunedSubjets"), cms.InputTag("pfSimpleSecondaryVertexHighEffBJetTagsAk8CHSJetsPrunedSubjets"), cms.InputTag("pfCombinedInclusiveSecondaryVertexV2BJetTagsAk8CHSJetsPrunedSubjets"), cms.InputTag("pfCombinedMVAV2BJetTagsAk8CHSJetsPrunedSubjets"), 
        cms.InputTag("pfBoostedDoubleSecondaryVertexAK8BJetTagsAk8CHSJetsPrunedSubjets"), cms.InputTag("pfBoostedDoubleSecondaryVertexCA15BJetTagsAk8CHSJetsPrunedSubjets")),
    efficiencies = cms.PSet(
    ...
    embedGenPartonMatch = cms.bool(True),
    embedPFCandidates = cms.bool(False),
    genJetMatch = cms.InputTag("patJetGenJetMatchAk8CHSJetsPrunedSubjets"),
    genPartonMatch = cms.InputTag("patJetPartonMatchAk8CHSJetsPrunedSubjets"),
    getJetMCFlavour = cms.bool(False),
    jetChargeSource = cms.InputTag(""),
    jetCorrFactorsSource = cms.VInputTag(cms.InputTag("patJetCorrFactorsAk8CHSJetsPrunedSubjets")),
    jetIDMap = cms.InputTag("ak4JetID"),
    jetSource = cms.InputTag("ak8CHSJetsPruned","SubJets"),
    partonJetSource = cms.InputTag("NOT_IMPLEMENTED"),
    resolutions = cms.PSet(

    ),
    tagInfoSources = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8CHSJetsPrunedSubjets"), cms.InputTag("pfSecondaryVertexTagInfosAk8CHSJetsPrunedSubjets"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosAk8CHSJetsPrunedSubjets"), cms.InputTag("softPFMuonsTagInfosAk8CHSJetsPrunedSubjets"), cms.InputTag("softPFElectronsTagInfosAk8CHSJetsPrunedSubjets"), 
        cms.InputTag("pfBoostedDoubleSVAK8TagInfosAk8CHSJetsPrunedSubjets"), cms.InputTag("pfImpactParameterAK8TagInfosAk8CHSJetsPrunedSubjets"), cms.InputTag("pfInclusiveSecondaryVertexFinderAK8TagInfosAk8CHSJetsPrunedSubjets"), cms.InputTag("pfBoostedDoubleSVCA15TagInfosAk8CHSJetsPrunedSubjets"), cms.InputTag("pfImpactParameterCA15TagInfosAk8CHSJetsPrunedSubjets"), 
        cms.InputTag("pfInclusiveSecondaryVertexFinderCA15TagInfosAk8CHSJetsPrunedSubjets")),
    trackAssociationSource = cms.InputTag(""),
    useLegacyJetMCFlavour = cms.bool(False),
    userData = cms.PSet(
        userCands = cms.PSet(
...
process.patJetsAk8CHSJetsSoftDrop = cms.EDProducer("PATJetProducer",
    ...
    addResolutions = cms.bool(False),
    addTagInfos = cms.bool(True),
    discriminatorSources = cms.VInputTag(cms.InputTag("pfJetProbabilityBJetTagsAk8CHSJetsSoftDrop"), cms.InputTag("pfJetBProbabilityBJetTagsAk8CHSJetsSoftDrop"), cms.InputTag("pfSimpleSecondaryVertexHighEffBJetTagsAk8CHSJetsSoftDrop"), cms.InputTag("pfCombinedInclusiveSecondaryVertexV2BJetTagsAk8CHSJetsSoftDrop"), cms.InputTag("pfCombinedMVAV2BJetTagsAk8CHSJetsSoftDrop"), 
        cms.InputTag("pfBoostedDoubleSecondaryVertexAK8BJetTagsAk8CHSJetsSoftDrop"), cms.InputTag("pfBoostedDoubleSecondaryVertexCA15BJetTagsAk8CHSJetsSoftDrop")),
    efficiencies = cms.PSet(
    ...
    tagInfoSources = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8CHSJetsSoftDrop"), cms.InputTag("pfSecondaryVertexTagInfosAk8CHSJetsSoftDrop"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosAk8CHSJetsSoftDrop"), cms.InputTag("softPFMuonsTagInfosAk8CHSJetsSoftDrop"), cms.InputTag("softPFElectronsTagInfosAk8CHSJetsSoftDrop"), 
        cms.InputTag("pfBoostedDoubleSVAK8TagInfosAk8CHSJetsSoftDrop"), cms.InputTag("pfImpactParameterAK8TagInfosAk8CHSJetsSoftDrop"), cms.InputTag("pfInclusiveSecondaryVertexFinderAK8TagInfosAk8CHSJetsSoftDrop"), cms.InputTag("pfBoostedDoubleSVCA15TagInfosAk8CHSJetsSoftDrop"), cms.InputTag("pfImpactParameterCA15TagInfosAk8CHSJetsSoftDrop"), 
        cms.InputTag("pfInclusiveSecondaryVertexFinderCA15TagInfosAk8CHSJetsSoftDrop")),
    trackAssociationSource = cms.InputTag(""),
    useLegacyJetMCFlavour = cms.bool(False),
    userData = cms.PSet(
        userCands = cms.PSet(
...
process.patJetsAk8CHSJetsSoftDropPacked = cms.EDProducer("BoostedJetMerger",
    ...
    subjetSrc = cms.InputTag("patJetsAk8CHSJetsSoftDropSubjets")
)
...
process.patJetsAk8CHSJetsSoftDropSubjets = cms.EDProducer("PATJetProducer",
    ...
    addResolutions = cms.bool(False),
    addTagInfos = cms.bool(True),
    discriminatorSources = cms.VInputTag(cms.InputTag("pfJetProbabilityBJetTagsAk8CHSJetsSoftDropSubjets"), cms.InputTag("pfJetBProbabilityBJetTagsAk8CHSJetsSoftDropSubjets"), cms.InputTag("pfSimpleSecondaryVertexHighEffBJetTagsAk8CHSJetsSoftDropSubjets"), cms.InputTag("pfCombinedInclusiveSecondaryVertexV2BJetTagsAk8CHSJetsSoftDropSubjets"), cms.InputTag("pfCombinedMVAV2BJetTagsAk8CHSJetsSoftDropSubjets"), 
        cms.InputTag("pfBoostedDoubleSecondaryVertexAK8BJetTagsAk8CHSJetsSoftDropSubjets"), cms.InputTag("pfBoostedDoubleSecondaryVertexCA15BJetTagsAk8CHSJetsSoftDropSubjets")),
    efficiencies = cms.PSet(
    ...
    tagInfoSources = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8CHSJetsSoftDropSubjets"), cms.InputTag("pfSecondaryVertexTagInfosAk8CHSJetsSoftDropSubjets"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosAk8CHSJetsSoftDropSubjets"), cms.InputTag("softPFMuonsTagInfosAk8CHSJetsSoftDropSubjets"), cms.InputTag("softPFElectronsTagInfosAk8CHSJetsSoftDropSubjets"), 
        cms.InputTag("pfBoostedDoubleSVAK8TagInfosAk8CHSJetsSoftDropSubjets"), cms.InputTag("pfImpactParameterAK8TagInfosAk8CHSJetsSoftDropSubjets"), cms.InputTag("pfInclusiveSecondaryVertexFinderAK8TagInfosAk8CHSJetsSoftDropSubjets"), cms.InputTag("pfBoostedDoubleSVCA15TagInfosAk8CHSJetsSoftDropSubjets"), cms.InputTag("pfImpactParameterCA15TagInfosAk8CHSJetsSoftDropSubjets"), 
        cms.InputTag("pfInclusiveSecondaryVertexFinderCA15TagInfosAk8CHSJetsSoftDropSubjets")),
    trackAssociationSource = cms.InputTag(""),
    useLegacyJetMCFlavour = cms.bool(False),
    userData = cms.PSet(
        userCands = cms.PSet(
...
process.patJetsAk8PuppiJetsFat = cms.EDProducer("PATJetProducer",
    ...
    addResolutions = cms.bool(False),
    addTagInfos = cms.bool(True),
    discriminatorSources = cms.VInputTag(cms.InputTag("pfJetProbabilityBJetTagsAk8PuppiJetsFat"), cms.InputTag("pfJetBProbabilityBJetTagsAk8PuppiJetsFat"), cms.InputTag("pfSimpleSecondaryVertexHighEffBJetTagsAk8PuppiJetsFat"), cms.InputTag("pfCombinedInclusiveSecondaryVertexV2BJetTagsAk8PuppiJetsFat"), cms.InputTag("pfCombinedMVAV2BJetTagsAk8PuppiJetsFat"), 
        cms.InputTag("pfBoostedDoubleSecondaryVertexAK8BJetTagsAk8PuppiJetsFat"), cms.InputTag("pfBoostedDoubleSecondaryVertexCA15BJetTagsAk8PuppiJetsFat")),
    efficiencies = cms.PSet(
    ...
    tagInfoSources = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8PuppiJetsFat"), cms.InputTag("pfSecondaryVertexTagInfosAk8PuppiJetsFat"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosAk8PuppiJetsFat"), cms.InputTag("softPFMuonsTagInfosAk8PuppiJetsFat"), cms.InputTag("softPFElectronsTagInfosAk8PuppiJetsFat"), 
        cms.InputTag("pfBoostedDoubleSVAK8TagInfosAk8PuppiJetsFat"), cms.InputTag("pfImpactParameterAK8TagInfosAk8PuppiJetsFat"), cms.InputTag("pfInclusiveSecondaryVertexFinderAK8TagInfosAk8PuppiJetsFat"), cms.InputTag("pfBoostedDoubleSVCA15TagInfosAk8PuppiJetsFat"), cms.InputTag("pfImpactParameterCA15TagInfosAk8PuppiJetsFat"), 
        cms.InputTag("pfInclusiveSecondaryVertexFinderCA15TagInfosAk8PuppiJetsFat")),
    trackAssociationSource = cms.InputTag(""),
    useLegacyJetMCFlavour = cms.bool(False),
    userData = cms.PSet(
        userCands = cms.PSet(
...
process.patJetsAk8PuppiJetsSoftDrop = cms.EDProducer("PATJetProducer",
    ...
    addResolutions = cms.bool(False),
    addTagInfos = cms.bool(True),
    discriminatorSources = cms.VInputTag(cms.InputTag("pfJetProbabilityBJetTagsAk8PuppiJetsSoftDrop"), cms.InputTag("pfJetBProbabilityBJetTagsAk8PuppiJetsSoftDrop"), cms.InputTag("pfSimpleSecondaryVertexHighEffBJetTagsAk8PuppiJetsSoftDrop"), cms.InputTag("pfCombinedInclusiveSecondaryVertexV2BJetTagsAk8PuppiJetsSoftDrop"), cms.InputTag("pfCombinedMVAV2BJetTagsAk8PuppiJetsSoftDrop"), 
        cms.InputTag("pfBoostedDoubleSecondaryVertexAK8BJetTagsAk8PuppiJetsSoftDrop"), cms.InputTag("pfBoostedDoubleSecondaryVertexCA15BJetTagsAk8PuppiJetsSoftDrop")),
    efficiencies = cms.PSet(
    ...
    tagInfoSources = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8PuppiJetsSoftDrop"), cms.InputTag("pfSecondaryVertexTagInfosAk8PuppiJetsSoftDrop"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosAk8PuppiJetsSoftDrop"), cms.InputTag("softPFMuonsTagInfosAk8PuppiJetsSoftDrop"), cms.InputTag("softPFElectronsTagInfosAk8PuppiJetsSoftDrop"), 
        cms.InputTag("pfBoostedDoubleSVAK8TagInfosAk8PuppiJetsSoftDrop"), cms.InputTag("pfImpactParameterAK8TagInfosAk8PuppiJetsSoftDrop"), cms.InputTag("pfInclusiveSecondaryVertexFinderAK8TagInfosAk8PuppiJetsSoftDrop"), cms.InputTag("pfBoostedDoubleSVCA15TagInfosAk8PuppiJetsSoftDrop"), cms.InputTag("pfImpactParameterCA15TagInfosAk8PuppiJetsSoftDrop"), 
        cms.InputTag("pfInclusiveSecondaryVertexFinderCA15TagInfosAk8PuppiJetsSoftDrop")),
    trackAssociationSource = cms.InputTag(""),
    useLegacyJetMCFlavour = cms.bool(False),
    userData = cms.PSet(
        userCands = cms.PSet(
...
process.patJetsAk8PuppiJetsSoftDropSubjets = cms.EDProducer("PATJetProducer",
    ...
    addResolutions = cms.bool(False),
    addTagInfos = cms.bool(True),
    discriminatorSources = cms.VInputTag(cms.InputTag("pfJetProbabilityBJetTagsAk8PuppiJetsSoftDropSubjets"), cms.InputTag("pfJetBProbabilityBJetTagsAk8PuppiJetsSoftDropSubjets"), cms.InputTag("pfSimpleSecondaryVertexHighEffBJetTagsAk8PuppiJetsSoftDropSubjets"), cms.InputTag("pfCombinedInclusiveSecondaryVertexV2BJetTagsAk8PuppiJetsSoftDropSubjets"), cms.InputTag("pfCombinedMVAV2BJetTagsAk8PuppiJetsSoftDropSubjets"), 
        cms.InputTag("pfBoostedDoubleSecondaryVertexAK8BJetTagsAk8PuppiJetsSoftDropSubjets"), cms.InputTag("pfBoostedDoubleSecondaryVertexCA15BJetTagsAk8PuppiJetsSoftDropSubjets")),
    efficiencies = cms.PSet(
    ...
    tagInfoSources = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8PuppiJetsSoftDropSubjets"), cms.InputTag("pfSecondaryVertexTagInfosAk8PuppiJetsSoftDropSubjets"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosAk8PuppiJetsSoftDropSubjets"), cms.InputTag("softPFMuonsTagInfosAk8PuppiJetsSoftDropSubjets"), cms.InputTag("softPFElectronsTagInfosAk8PuppiJetsSoftDropSubjets"), 
        cms.InputTag("pfBoostedDoubleSVAK8TagInfosAk8PuppiJetsSoftDropSubjets"), cms.InputTag("pfImpactParameterAK8TagInfosAk8PuppiJetsSoftDropSubjets"), cms.InputTag("pfInclusiveSecondaryVertexFinderAK8TagInfosAk8PuppiJetsSoftDropSubjets"), cms.InputTag("pfBoostedDoubleSVCA15TagInfosAk8PuppiJetsSoftDropSubjets"), cms.InputTag("pfImpactParameterCA15TagInfosAk8PuppiJetsSoftDropSubjets"), 
        cms.InputTag("pfInclusiveSecondaryVertexFinderCA15TagInfosAk8PuppiJetsSoftDropSubjets")),
    trackAssociationSource = cms.InputTag(""),
    useLegacyJetMCFlavour = cms.bool(False),
    userData = cms.PSet(
        userCands = cms.PSet(
...
process.pfBoostedDoubleSVAK8TagInfosAk8CHSJets = cms.EDProducer("BoostedDoubleSVProducer",
    R0 = cms.double(0.8),
    beta = cms.double(1.0),
    maxSVDeltaRToJet = cms.double(0.7),
    svTagInfos = cms.InputTag("pfInclusiveSecondaryVertexFinderAK8TagInfosAk8CHSJets"),
    trackPairV0Filter = cms.PSet(
        k0sMassWindow = cms.double(0.03)
    ),
    trackSelection = cms.PSet(
...
process.pfBoostedDoubleSVAK8TagInfosAk8CHSJetsPruned = cms.EDProducer("BoostedDoubleSVProducer",
    R0 = cms.double(0.8),
    beta = cms.double(1.0),
    maxSVDeltaRToJet = cms.double(0.7),
    svTagInfos = cms.InputTag("pfInclusiveSecondaryVertexFinderAK8TagInfosAk8CHSJetsPruned"),
    trackPairV0Filter = cms.PSet(
        k0sMassWindow = cms.double(0.03)
    ),
    trackSelection = cms.PSet(
...
process.pfBoostedDoubleSVAK8TagInfosAk8CHSJetsPrunedSubjets = cms.EDProducer("BoostedDoubleSVProducer",
    R0 = cms.double(0.8),
    beta = cms.double(1.0),
    maxSVDeltaRToJet = cms.double(0.7),
    svTagInfos = cms.InputTag("pfInclusiveSecondaryVertexFinderAK8TagInfosAk8CHSJetsPrunedSubjets"),
    trackPairV0Filter = cms.PSet(
        k0sMassWindow = cms.double(0.03)
    ),
    trackSelection = cms.PSet(
...
process.pfBoostedDoubleSVCA15TagInfosAk8CHSJets = cms.EDProducer("BoostedDoubleSVProducer",
    R0 = cms.double(1.5),
    beta = cms.double(1.0),
    maxSVDeltaRToJet = cms.double(1.0),
    svTagInfos = cms.InputTag("pfInclusiveSecondaryVertexFinderCA15TagInfosAk8CHSJets"),
    trackPairV0Filter = cms.PSet(
        k0sMassWindow = cms.double(0.03)
    ),
    trackSelection = cms.PSet(
...
process.pfBoostedDoubleSVCA15TagInfosAk8CHSJetsPruned = cms.EDProducer("BoostedDoubleSVProducer",
    R0 = cms.double(1.5),
    beta = cms.double(1.0),
    maxSVDeltaRToJet = cms.double(1.0),
    svTagInfos = cms.InputTag("pfInclusiveSecondaryVertexFinderCA15TagInfosAk8CHSJetsPruned"),
    trackPairV0Filter = cms.PSet(
        k0sMassWindow = cms.double(0.03)
    ),
    trackSelection = cms.PSet(
...
process.pfBoostedDoubleSVCA15TagInfosAk8CHSJetsPrunedSubjets = cms.EDProducer("BoostedDoubleSVProducer",
    R0 = cms.double(1.5),
    beta = cms.double(1.0),
    maxSVDeltaRToJet = cms.double(1.0),
    svTagInfos = cms.InputTag("pfInclusiveSecondaryVertexFinderCA15TagInfosAk8CHSJetsPrunedSubjets"),
    trackPairV0Filter = cms.PSet(
        k0sMassWindow = cms.double(0.03)
    ),
    trackSelection = cms.PSet(
...
process.pfBoostedDoubleSecondaryVertexAK8BJetTagsAk8CHSJets = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateBoostedDoubleSecondaryVertexAK8Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfBoostedDoubleSVAK8TagInfosAk8CHSJets"))
)


process.pfBoostedDoubleSecondaryVertexAK8BJetTagsAk8CHSJetsPruned = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateBoostedDoubleSecondaryVertexAK8Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfBoostedDoubleSVAK8TagInfosAk8CHSJetsPruned"))
)


process.pfBoostedDoubleSecondaryVertexAK8BJetTagsAk8CHSJetsPrunedSubjets = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateBoostedDoubleSecondaryVertexAK8Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfBoostedDoubleSVAK8TagInfosAk8CHSJetsPrunedSubjets"))
)
...
process.pfBoostedDoubleSecondaryVertexCA15BJetTagsAk8CHSJets = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateBoostedDoubleSecondaryVertexCA15Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfBoostedDoubleSVCA15TagInfosAk8CHSJets"))
)


process.pfBoostedDoubleSecondaryVertexCA15BJetTagsAk8CHSJetsPruned = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateBoostedDoubleSecondaryVertexCA15Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfBoostedDoubleSVCA15TagInfosAk8CHSJetsPruned"))
)


process.pfBoostedDoubleSecondaryVertexCA15BJetTagsAk8CHSJetsPrunedSubjets = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateBoostedDoubleSecondaryVertexCA15Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfBoostedDoubleSVCA15TagInfosAk8CHSJetsPrunedSubjets"))
)
...
process.pfCombinedInclusiveSecondaryVertexV2BJetTagsAk8CHSJets = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateCombinedSecondaryVertexV2Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8CHSJets"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosAk8CHSJets"))
)


process.pfCombinedInclusiveSecondaryVertexV2BJetTagsAk8CHSJetsPruned = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateCombinedSecondaryVertexV2Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8CHSJetsPruned"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosAk8CHSJetsPruned"))
)


process.pfCombinedInclusiveSecondaryVertexV2BJetTagsAk8CHSJetsPrunedSubjets = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateCombinedSecondaryVertexV2Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8CHSJetsPrunedSubjets"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosAk8CHSJetsPrunedSubjets"))
)


process.pfCombinedInclusiveSecondaryVertexV2BJetTagsAk8CHSJetsSoftDrop = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateCombinedSecondaryVertexV2Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8CHSJetsSoftDrop"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosAk8CHSJetsSoftDrop"))
)


process.pfCombinedInclusiveSecondaryVertexV2BJetTagsAk8CHSJetsSoftDropSubjets = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateCombinedSecondaryVertexV2Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8CHSJetsSoftDropSubjets"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosAk8CHSJetsSoftDropSubjets"))
)


process.pfCombinedInclusiveSecondaryVertexV2BJetTagsAk8PuppiJetsFat = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateCombinedSecondaryVertexV2Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8PuppiJetsFat"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosAk8PuppiJetsFat"))
)
...
process.pfCombinedMVAV2BJetTagsAk8CHSJets = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateCombinedMVAV2Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8CHSJets"), cms.InputTag("pfSecondaryVertexTagInfosAk8CHSJets"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosAk8CHSJets"), cms.InputTag("softPFMuonsTagInfosAk8CHSJets"), cms.InputTag("softPFElectronsTagInfosAk8CHSJets"))
)


process.pfCombinedMVAV2BJetTagsAk8CHSJetsPruned = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateCombinedMVAV2Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8CHSJetsPruned"), cms.InputTag("pfSecondaryVertexTagInfosAk8CHSJetsPruned"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosAk8CHSJetsPruned"), cms.InputTag("softPFMuonsTagInfosAk8CHSJetsPruned"), cms.InputTag("softPFElectronsTagInfosAk8CHSJetsPruned"))
)


process.pfCombinedMVAV2BJetTagsAk8CHSJetsPrunedSubjets = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateCombinedMVAV2Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8CHSJetsPrunedSubjets"), cms.InputTag("pfSecondaryVertexTagInfosAk8CHSJetsPrunedSubjets"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosAk8CHSJetsPrunedSubjets"), cms.InputTag("softPFMuonsTagInfosAk8CHSJetsPrunedSubjets"), cms.InputTag("softPFElectronsTagInfosAk8CHSJetsPrunedSubjets"))
)


process.pfCombinedMVAV2BJetTagsAk8CHSJetsSoftDrop = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateCombinedMVAV2Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8CHSJetsSoftDrop"), cms.InputTag("pfSecondaryVertexTagInfosAk8CHSJetsSoftDrop"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosAk8CHSJetsSoftDrop"), cms.InputTag("softPFMuonsTagInfosAk8CHSJetsSoftDrop"), cms.InputTag("softPFElectronsTagInfosAk8CHSJetsSoftDrop"))
)


process.pfCombinedMVAV2BJetTagsAk8CHSJetsSoftDropSubjets = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateCombinedMVAV2Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8CHSJetsSoftDropSubjets"), cms.InputTag("pfSecondaryVertexTagInfosAk8CHSJetsSoftDropSubjets"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosAk8CHSJetsSoftDropSubjets"), cms.InputTag("softPFMuonsTagInfosAk8CHSJetsSoftDropSubjets"), cms.InputTag("softPFElectronsTagInfosAk8CHSJetsSoftDropSubjets"))
)


process.pfCombinedMVAV2BJetTagsAk8PuppiJetsFat = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateCombinedMVAV2Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8PuppiJetsFat"), cms.InputTag("pfSecondaryVertexTagInfosAk8PuppiJetsFat"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosAk8PuppiJetsFat"), cms.InputTag("softPFMuonsTagInfosAk8PuppiJetsFat"), cms.InputTag("softPFElectronsTagInfosAk8PuppiJetsFat"))
)


process.pfCombinedMVAV2BJetTagsAk8PuppiJetsSoftDrop = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateCombinedMVAV2Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8PuppiJetsSoftDrop"), cms.InputTag("pfSecondaryVertexTagInfosAk8PuppiJetsSoftDrop"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosAk8PuppiJetsSoftDrop"), cms.InputTag("softPFMuonsTagInfosAk8PuppiJetsSoftDrop"), cms.InputTag("softPFElectronsTagInfosAk8PuppiJetsSoftDrop"))
)


process.pfCombinedMVAV2BJetTagsAk8PuppiJetsSoftDropSubjets = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateCombinedMVAV2Computer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8PuppiJetsSoftDropSubjets"), cms.InputTag("pfSecondaryVertexTagInfosAk8PuppiJetsSoftDropSubjets"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfosAk8PuppiJetsSoftDropSubjets"), cms.InputTag("softPFMuonsTagInfosAk8PuppiJetsSoftDropSubjets"), cms.InputTag("softPFElectronsTagInfosAk8PuppiJetsSoftDropSubjets"))
)


process.pfImpactParameterAK8TagInfosAk8CHSJets = cms.EDProducer("CandIPProducer",
...
process.pfImpactParameterAK8TagInfosAk8CHSJetsPruned = cms.EDProducer("CandIPProducer",
    candidates = cms.InputTag("packedPFCandidates"),
    computeGhostTrack = cms.bool(False),
    computeProbabilities = cms.bool(False),
    ghostTrackPriorDeltaR = cms.double(0.03),
...
process.pfImpactParameterAK8TagInfosAk8CHSJetsPrunedSubjets = cms.EDProducer("CandIPProducer",
    candidates = cms.InputTag("packedPFCandidates"),
    computeGhostTrack = cms.bool(False),
    computeProbabilities = cms.bool(False),
...
process.pfImpactParameterCA15TagInfosAk8CHSJets = cms.EDProducer("CandIPProducer",
    candidates = cms.InputTag("packedPFCandidates"),
    computeGhostTrack = cms.bool(False),
    computeProbabilities = cms.bool(False),
    ghostTrackPriorDeltaR = cms.double(0.03),
...
process.pfImpactParameterCA15TagInfosAk8CHSJetsPruned = cms.EDProducer("CandIPProducer",
    candidates = cms.InputTag("packedPFCandidates"),
    computeGhostTrack = cms.bool(False),
    computeProbabilities = cms.bool(False),
    ghostTrackPriorDeltaR = cms.double(0.03),
...
process.pfImpactParameterCA15TagInfosAk8CHSJetsPrunedSubjets = cms.EDProducer("CandIPProducer",
    candidates = cms.InputTag("packedPFCandidates"),
    computeGhostTrack = cms.bool(False),
    computeProbabilities = cms.bool(False),
    explicitJTA = cms.bool(True),
...
process.pfImpactParameterTagInfosAk8CHSJets = cms.EDProducer("CandIPProducer",
    candidates = cms.InputTag("packedPFCandidates"),
...
process.pfImpactParameterTagInfosAk8CHSJetsPruned = cms.EDProducer("CandIPProducer",
    candidates = cms.InputTag("packedPFCandidates"),
    computeGhostTrack = cms.bool(True),
    computeProbabilities = cms.bool(True),
    ghostTrackPriorDeltaR = cms.double(0.03),
...
process.pfImpactParameterTagInfosAk8CHSJetsPrunedSubjets = cms.EDProducer("CandIPProducer",
    candidates = cms.InputTag("packedPFCandidates"),
    computeGhostTrack = cms.bool(True),
    computeProbabilities = cms.bool(True),
    explicitJTA = cms.bool(True),
...
process.pfInclusiveSecondaryVertexFinderAK8TagInfosAk8CHSJets = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
    extSVCollection = cms.InputTag("slimmedSecondaryVertices"),
    extSVDeltaRToJet = cms.double(0.8),
    minimumTrackWeight = cms.double(0.5),
    trackIPTagInfos = cms.InputTag("pfImpactParameterAK8TagInfosAk8CHSJets"),
    trackSelection = cms.PSet(
        a_dR = cms.double(-0.001053),
        a_pT = cms.double(0.005263),
        b_dR = cms.double(0.6263),
...
process.pfInclusiveSecondaryVertexFinderAK8TagInfosAk8CHSJetsPruned = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
    extSVCollection = cms.InputTag("slimmedSecondaryVertices"),
    extSVDeltaRToJet = cms.double(0.8),
    minimumTrackWeight = cms.double(0.5),
    trackIPTagInfos = cms.InputTag("pfImpactParameterAK8TagInfosAk8CHSJetsPruned"),
    trackSelection = cms.PSet(
        a_dR = cms.double(-0.001053),
        a_pT = cms.double(0.005263),
        b_dR = cms.double(0.6263),
...
process.pfInclusiveSecondaryVertexFinderAK8TagInfosAk8CHSJetsPrunedSubjets = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
    extSVCollection = cms.InputTag("slimmedSecondaryVertices"),
    extSVDeltaRToJet = cms.double(0.8),
    fatJets = cms.InputTag("ak8CHSJets"),
    groomedFatJets = cms.InputTag("ak8CHSJetsPruned"),
    jetAlgorithm = cms.string('AntiKt'),
    minimumTrackWeight = cms.double(0.5),
    rParam = cms.double(0.8),
    trackIPTagInfos = cms.InputTag("pfImpactParameterAK8TagInfosAk8CHSJetsPrunedSubjets"),
    trackSelection = cms.PSet(
        a_dR = cms.double(-0.001053),
        a_pT = cms.double(0.005263),
        b_dR = cms.double(0.6263),
...
process.pfInclusiveSecondaryVertexFinderCA15TagInfosAk8CHSJets = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
    extSVCollection = cms.InputTag("slimmedSecondaryVertices"),
    extSVDeltaRToJet = cms.double(1.5),
    minimumTrackWeight = cms.double(0.5),
    trackIPTagInfos = cms.InputTag("pfImpactParameterCA15TagInfosAk8CHSJets"),
    trackSelection = cms.PSet(
        a_dR = cms.double(-0.001053),
        a_pT = cms.double(0.005263),
        b_dR = cms.double(0.6263),
...
process.pfInclusiveSecondaryVertexFinderCA15TagInfosAk8CHSJetsPruned = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
    extSVCollection = cms.InputTag("slimmedSecondaryVertices"),
    extSVDeltaRToJet = cms.double(1.5),
    minimumTrackWeight = cms.double(0.5),
    trackIPTagInfos = cms.InputTag("pfImpactParameterCA15TagInfosAk8CHSJetsPruned"),
    trackSelection = cms.PSet(
        a_dR = cms.double(-0.001053),
        a_pT = cms.double(0.005263),
        b_dR = cms.double(0.6263),
...
process.pfInclusiveSecondaryVertexFinderCA15TagInfosAk8CHSJetsPrunedSubjets = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
    extSVCollection = cms.InputTag("slimmedSecondaryVertices"),
    extSVDeltaRToJet = cms.double(1.5),
    ...
    minimumTrackWeight = cms.double(0.5),
    rParam = cms.double(0.8),
    trackIPTagInfos = cms.InputTag("pfImpactParameterCA15TagInfosAk8CHSJetsPrunedSubjets"),
    trackSelection = cms.PSet(
        a_dR = cms.double(-0.001053),
        a_pT = cms.double(0.005263),
        b_dR = cms.double(0.6263),
...
process.pfInclusiveSecondaryVertexFinderTagInfosAk8CHSJets = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
    extSVCollection = cms.InputTag("slimmedSecondaryVertices"),
    extSVDeltaRToJet = cms.double(0.3),
    minimumTrackWeight = cms.double(0.5),
    trackIPTagInfos = cms.InputTag("pfImpactParameterTagInfosAk8CHSJets"),
    trackSelection = cms.PSet(
        a_dR = cms.double(-0.001053),
        a_pT = cms.double(0.005263),
        b_dR = cms.double(0.6263),
...
process.pfInclusiveSecondaryVertexFinderTagInfosAk8CHSJetsPruned = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
    extSVCollection = cms.InputTag("slimmedSecondaryVertices"),
    extSVDeltaRToJet = cms.double(0.3),
    minimumTrackWeight = cms.double(0.5),
    trackIPTagInfos = cms.InputTag("pfImpactParameterTagInfosAk8CHSJetsPruned"),
    trackSelection = cms.PSet(
        a_dR = cms.double(-0.001053),
        a_pT = cms.double(0.005263),
        b_dR = cms.double(0.6263),
...
process.pfInclusiveSecondaryVertexFinderTagInfosAk8CHSJetsPrunedSubjets = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
    extSVCollection = cms.InputTag("slimmedSecondaryVertices"),
    extSVDeltaRToJet = cms.double(0.3),
    ...
    minimumTrackWeight = cms.double(0.5),
    rParam = cms.double(0.8),
    trackIPTagInfos = cms.InputTag("pfImpactParameterTagInfosAk8CHSJetsPrunedSubjets"),
    trackSelection = cms.PSet(
        a_dR = cms.double(-0.001053),
        a_pT = cms.double(0.005263),
        b_dR = cms.double(0.6263),
...
process.pfJetBProbabilityBJetTagsAk8CHSJets = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateJetBProbabilityComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8CHSJets"))
)


process.pfJetBProbabilityBJetTagsAk8CHSJetsPruned = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateJetBProbabilityComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8CHSJetsPruned"))
)


process.pfJetBProbabilityBJetTagsAk8CHSJetsPrunedSubjets = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateJetBProbabilityComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8CHSJetsPrunedSubjets"))
)


process.pfJetBProbabilityBJetTagsAk8CHSJetsSoftDrop = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateJetBProbabilityComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8CHSJetsSoftDrop"))
)


process.pfJetBProbabilityBJetTagsAk8CHSJetsSoftDropSubjets = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateJetBProbabilityComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8CHSJetsSoftDropSubjets"))
)


process.pfJetBProbabilityBJetTagsAk8PuppiJetsFat = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateJetBProbabilityComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8PuppiJetsFat"))
)


process.pfJetBProbabilityBJetTagsAk8PuppiJetsSoftDrop = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateJetBProbabilityComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8PuppiJetsSoftDrop"))
)


process.pfJetBProbabilityBJetTagsAk8PuppiJetsSoftDropSubjets = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateJetBProbabilityComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8PuppiJetsSoftDropSubjets"))
)


process.pfJetProbabilityBJetTagsAk8CHSJets = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateJetProbabilityComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8CHSJets"))
)


process.pfJetProbabilityBJetTagsAk8CHSJetsPruned = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateJetProbabilityComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8CHSJetsPruned"))
)


process.pfJetProbabilityBJetTagsAk8CHSJetsPrunedSubjets = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateJetProbabilityComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8CHSJetsPrunedSubjets"))
)


process.pfJetProbabilityBJetTagsAk8CHSJetsSoftDrop = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateJetProbabilityComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8CHSJetsSoftDrop"))
)


process.pfJetProbabilityBJetTagsAk8CHSJetsSoftDropSubjets = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateJetProbabilityComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8CHSJetsSoftDropSubjets"))
)


process.pfJetProbabilityBJetTagsAk8PuppiJetsFat = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateJetProbabilityComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8PuppiJetsFat"))
)


process.pfJetProbabilityBJetTagsAk8PuppiJetsSoftDrop = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateJetProbabilityComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8PuppiJetsSoftDrop"))
)


process.pfJetProbabilityBJetTagsAk8PuppiJetsSoftDropSubjets = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateJetProbabilityComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfImpactParameterTagInfosAk8PuppiJetsSoftDropSubjets"))
)
...
process.pfSecondaryVertexTagInfosAk8CHSJets = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
...
process.pfSecondaryVertexTagInfosAk8CHSJetsPruned = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
    extSVCollection = cms.InputTag("secondaryVertices"),
    extSVDeltaRToJet = cms.double(0.3),
...
process.pfSecondaryVertexTagInfosAk8CHSJetsPrunedSubjets = cms.EDProducer("CandSecondaryVertexProducer",
    beamSpotTag = cms.InputTag("offlineBeamSpot"),
    constraint = cms.string('BeamSpot'),
    extSVCollection = cms.InputTag("secondaryVertices"),
    extSVDeltaRToJet = cms.double(0.3),
...
process.pfSimpleSecondaryVertexHighEffBJetTagsAk8CHSJets = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateSimpleSecondaryVertex2TrkComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfSecondaryVertexTagInfosAk8CHSJets"))
)


process.pfSimpleSecondaryVertexHighEffBJetTagsAk8CHSJetsPruned = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateSimpleSecondaryVertex2TrkComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfSecondaryVertexTagInfosAk8CHSJetsPruned"))
)


process.pfSimpleSecondaryVertexHighEffBJetTagsAk8CHSJetsPrunedSubjets = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateSimpleSecondaryVertex2TrkComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfSecondaryVertexTagInfosAk8CHSJetsPrunedSubjets"))
)


process.pfSimpleSecondaryVertexHighEffBJetTagsAk8CHSJetsSoftDrop = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateSimpleSecondaryVertex2TrkComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfSecondaryVertexTagInfosAk8CHSJetsSoftDrop"))
)


process.pfSimpleSecondaryVertexHighEffBJetTagsAk8CHSJetsSoftDropSubjets = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateSimpleSecondaryVertex2TrkComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfSecondaryVertexTagInfosAk8CHSJetsSoftDropSubjets"))
)


process.pfSimpleSecondaryVertexHighEffBJetTagsAk8PuppiJetsFat = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateSimpleSecondaryVertex2TrkComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfSecondaryVertexTagInfosAk8PuppiJetsFat"))
)


process.pfSimpleSecondaryVertexHighEffBJetTagsAk8PuppiJetsSoftDrop = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateSimpleSecondaryVertex2TrkComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfSecondaryVertexTagInfosAk8PuppiJetsSoftDrop"))
)


process.pfSimpleSecondaryVertexHighEffBJetTagsAk8PuppiJetsSoftDropSubjets = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateSimpleSecondaryVertex2TrkComputer'),
    tagInfos = cms.VInputTag(cms.InputTag("pfSecondaryVertexTagInfosAk8PuppiJetsSoftDropSubjets"))
)
...
process.slMETsCHS = cms.EDProducer("PATMETSlimmer",
...
process.softPFElectronsTagInfosAk8CHSJets = cms.EDProducer("SoftPFElectronTagInfoProducer",
...
process.softPFElectronsTagInfosAk8CHSJetsPruned = cms.EDProducer("SoftPFElectronTagInfoProducer",
    DeltaRElectronJet = cms.double(0.4),
    MaxSip3Dsig = cms.double(200),
    electrons = cms.InputTag("slimmedElectrons"),
    jets = cms.InputTag("ak8CHSJetsPruned"),
...
process.softPFElectronsTagInfosAk8CHSJetsPrunedSubjets = cms.EDProducer("SoftPFElectronTagInfoProducer",
    DeltaRElectronJet = cms.double(0.4),
    MaxSip3Dsig = cms.double(200),
    electrons = cms.InputTag("slimmedElectrons"),
    jets = cms.InputTag("ak8CHSJetsPruned","SubJets"),
...
process.softPFMuonsTagInfosAk8CHSJets = cms.EDProducer("SoftPFMuonTagInfoProducer",
...
process.softPFMuonsTagInfosAk8CHSJetsPruned = cms.EDProducer("SoftPFMuonTagInfoProducer",
    filterIpsig = cms.double(4.0),
    filterPromptMuons = cms.bool(False),
    filterRatio1 = cms.double(0.4),
    filterRatio2 = cms.double(0.7),
...
process.softPFMuonsTagInfosAk8CHSJetsPrunedSubjets = cms.EDProducer("SoftPFMuonTagInfoProducer",
    filterIpsig = cms.double(4.0),
    filterPromptMuons = cms.bool(False),
    filterRatio1 = cms.double(0.4),
    filterRatio2 = cms.double(0.7),
...
process.MyNtuple = cms.EDFilter("NtupleWriter",
    ...
    gentopjet_sources = cms.VInputTag(cms.InputTag("ak8GenJets"), cms.InputTag("ak8GenJetsSoftDrop")),
    gentopjet_tau1 = cms.VInputTag(cms.InputTag("NjettinessAk8Gen","tau1"), cms.InputTag("NjettinessAk8SoftDropGen","tau1")),
    gentopjet_tau2 = cms.VInputTag(cms.InputTag("NjettinessAk8Gen","tau2"), cms.InputTag("NjettinessAk8SoftDropGen","tau2")),
    gentopjet_tau3 = cms.VInputTag(cms.InputTag("NjettinessAk8Gen","tau3"), cms.InputTag("NjettinessAk8SoftDropGen","tau3")),
    jet_etamax = cms.double(999.0),
    jet_ptmin = cms.double(10.0),
    jet_sources = cms.vstring('slimmedJets', 
        'slimmedJetsPuppi', 
        'slimmedJetsAK8', 
    ...
    met_sources = cms.vstring('slimmedMETs', 
        'slimmedMETsPuppi', 
        'slMETsCHS'),
    metfilter_bits = cms.InputTag("TriggerResults","","HLT"),
...
process.selectedPatJetsAk8CHSJets = cms.EDFilter("PATJetSelector",
    cut = cms.string(''),
    src = cms.InputTag("patJetsAk8CHSJets")
)


process.selectedPatJetsAk8CHSJetsPruned = cms.EDFilter("PATJetSelector",
    cut = cms.string(''),
    src = cms.InputTag("patJetsAk8CHSJetsPruned")
)


process.selectedPatJetsAk8CHSJetsPrunedSubjets = cms.EDFilter("PATJetSelector",
    cut = cms.string(''),
    src = cms.InputTag("patJetsAk8CHSJetsPrunedSubjets")
)


process.selectedPatJetsAk8CHSJetsSoftDrop = cms.EDFilter("PATJetSelector",
    cut = cms.string(''),
    src = cms.InputTag("patJetsAk8CHSJetsSoftDrop")
)


process.selectedPatJetsAk8CHSJetsSoftDropSubjets = cms.EDFilter("PATJetSelector",
    cut = cms.string(''),
    src = cms.InputTag("patJetsAk8CHSJetsSoftDropSubjets")
)


process.selectedPatJetsAk8PuppiJetsFat = cms.EDFilter("PATJetSelector",
    cut = cms.string(''),
    src = cms.InputTag("patJetsAk8PuppiJetsFat")
)
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('93X_upgrade2023_realistic_v2'),
...
process.siPixelFakeLorentzAngleESSource = cms.ESSource("SiPixelFakeLorentzAngleESSource",
    file = cms.FileInPath('SLHCUpgradeSimulations/Geometry/data/PhaseII/Tilted/PixelSkimmedGeometry4025.txt')
)
...
process.patAlgosToolsTask = cms.Task(process.patJetCorrFactorsAK8PFCHS, process.patJetCorrFactorsAK8PFPUPPI, process.patJetCorrFactorsAk8CHSJets, process.patJetCorrFactorsAk8CHSJetsPruned, process.patJetCorrFactorsAk8CHSJetsPrunedSubjets, process.patJetCorrFactorsAk8CHSJetsSoftDrop, process.patJetCorrFactorsAk8CHSJetsSoftDropSubjets, process.patJetCorrFactorsAk8PuppiJetsFat, process.patJetCorrFactorsAk8PuppiJetsSoftDrop, process.patJetCorrFactorsAk8PuppiJetsSoftDropSubjets, process.patJetFlavourAssociationAK8PFCHS, process.patJetFlavourAssociationAK8PFPUPPI, process.patJetFlavourAssociationAk8CHSJets, process.patJetFlavourAssociationAk8CHSJetsPruned, process.patJetFlavourAssociationAk8CHSJetsPrunedSubjets, process.patJetFlavourAssociationAk8CHSJetsSoftDrop, process.patJetFlavourAssociationAk8CHSJetsSoftDropSubjets, process.patJetFlavourAssociationAk8PuppiJetsFat, process.patJetFlavourAssociationAk8PuppiJetsSoftDrop, process.patJetFlavourAssociationAk8PuppiJetsSoftDropSubjets, process.patJetFlavourAssociationLegacyAK8PFCHS, process.patJetFlavourAssociationLegacyAK8PFPUPPI, process.patJetFlavourAssociationLegacyAk8CHSJets, process.patJetFlavourAssociationLegacyAk8CHSJetsPruned, process.patJetFlavourAssociationLegacyAk8CHSJetsPrunedSubjets, process.patJetFlavourAssociationLegacyAk8CHSJetsSoftDrop, process.patJetFlavourAssociationLegacyAk8CHSJetsSoftDropSubjets, process.patJetFlavourAssociationLegacyAk8PuppiJetsFat, process.patJetFlavourAssociationLegacyAk8PuppiJetsSoftDrop, process.patJetFlavourAssociationLegacyAk8PuppiJetsSoftDropSubjets, process.patJetGenJetMatchAK8PFCHS, process.patJetGenJetMatchAK8PFPUPPI, process.patJetGenJetMatchAk8CHSJets, process.patJetGenJetMatchAk8CHSJetsPruned, process.patJetGenJetMatchAk8CHSJetsPrunedSubjets, process.patJetGenJetMatchAk8CHSJetsSoftDrop, process.patJetGenJetMatchAk8CHSJetsSoftDropSubjets, process.patJetGenJetMatchAk8PuppiJetsFat, process.patJetGenJetMatchAk8PuppiJetsSoftDrop, process.patJetGenJetMatchAk8PuppiJetsSoftDropSubjets, process.patJetPartonAssociationLegacyAK8PFCHS, process.patJetPartonAssociationLegacyAK8PFPUPPI, process.patJetPartonAssociationLegacyAk8CHSJets, process.patJetPartonAssociationLegacyAk8CHSJetsPruned, process.patJetPartonAssociationLegacyAk8CHSJetsPrunedSubjets, process.patJetPartonAssociationLegacyAk8CHSJetsSoftDrop, process.patJetPartonAssociationLegacyAk8CHSJetsSoftDropSubjets, process.patJetPartonAssociationLegacyAk8PuppiJetsFat, process.patJetPartonAssociationLegacyAk8PuppiJetsSoftDrop, process.patJetPartonAssociationLegacyAk8PuppiJetsSoftDropSubjets, process.patJetPartonMatchAK8PFCHS, process.patJetPartonMatchAK8PFPUPPI, process.patJetPartonMatchAk8CHSJets, process.patJetPartonMatchAk8CHSJetsPruned, process.patJetPartonMatchAk8CHSJetsPrunedSubjets, process.patJetPartonMatchAk8CHSJetsSoftDrop, process.patJetPartonMatchAk8CHSJetsSoftDropSubjets, process.patJetPartonMatchAk8PuppiJetsFat, process.patJetPartonMatchAk8PuppiJetsSoftDrop, process.patJetPartonMatchAk8PuppiJetsSoftDropSubjets, process.patJetPartons, process.patJetPartonsLegacy, process.patJetsAK8PFCHS, process.patJetsAK8PFPUPPI, process.patJetsAk8CHSJets, process.patJetsAk8CHSJetsPruned, process.patJetsAk8CHSJetsPrunedSubjets, process.patJetsAk8CHSJetsSoftDrop, process.patJetsAk8CHSJetsSoftDropSubjets, process.patJetsAk8PuppiJetsFat, process.patJetsAk8PuppiJetsSoftDrop, process.patJetsAk8PuppiJetsSoftDropSubjets, process.patPFMet, process.patPFMetCHS, process.pfBoostedDoubleSVAK8TagInfosAk8CHSJets, process.pfBoostedDoubleSVAK8TagInfosAk8CHSJetsPruned, process.pfBoostedDoubleSVAK8TagInfosAk8CHSJetsPrunedSubjets, process.pfBoostedDoubleSVAK8TagInfosAk8CHSJetsSoftDrop, process.pfBoostedDoubleSVAK8TagInfosAk8CHSJetsSoftDropSubjets, process.pfBoostedDoubleSVAK8TagInfosAk8PuppiJetsFat, process.pfBoostedDoubleSVAK8TagInfosAk8PuppiJetsSoftDrop, process.pfBoostedDoubleSVAK8TagInfosAk8PuppiJetsSoftDropSubjets, process.pfBoostedDoubleSVCA15TagInfosAk8CHSJets, process.pfBoostedDoubleSVCA15TagInfosAk8CHSJetsPruned, process.pfBoostedDoubleSVCA15TagInfosAk8CHSJetsPrunedSubjets, process.pfBoostedDoubleSVCA15TagInfosAk8CHSJetsSoftDrop, process.pfBoostedDoubleSVCA15TagInfosAk8CHSJetsSoftDropSubjets, process.pfBoostedDoubleSVCA15TagInfosAk8PuppiJetsFat, process.pfBoostedDoubleSVCA15TagInfosAk8PuppiJetsSoftDrop, process.pfBoostedDoubleSVCA15TagInfosAk8PuppiJetsSoftDropSubjets, process.pfBoostedDoubleSecondaryVertexAK8BJetTagsAk8CHSJets, process.pfBoostedDoubleSecondaryVertexAK8BJetTagsAk8CHSJetsPruned, process.pfBoostedDoubleSecondaryVertexAK8BJetTagsAk8CHSJetsPrunedSubjets, process.pfBoostedDoubleSecondaryVertexAK8BJetTagsAk8CHSJetsSoftDrop, process.pfBoostedDoubleSecondaryVertexAK8BJetTagsAk8CHSJetsSoftDropSubjets, process.pfBoostedDoubleSecondaryVertexAK8BJetTagsAk8PuppiJetsFat, process.pfBoostedDoubleSecondaryVertexAK8BJetTagsAk8PuppiJetsSoftDrop, process.pfBoostedDoubleSecondaryVertexAK8BJetTagsAk8PuppiJetsSoftDropSubjets, process.pfBoostedDoubleSecondaryVertexCA15BJetTagsAk8CHSJets, process.pfBoostedDoubleSecondaryVertexCA15BJetTagsAk8CHSJetsPruned, process.pfBoostedDoubleSecondaryVertexCA15BJetTagsAk8CHSJetsPrunedSubjets, process.pfBoostedDoubleSecondaryVertexCA15BJetTagsAk8CHSJetsSoftDrop, process.pfBoostedDoubleSecondaryVertexCA15BJetTagsAk8CHSJetsSoftDropSubjets, process.pfBoostedDoubleSecondaryVertexCA15BJetTagsAk8PuppiJetsFat, process.pfBoostedDoubleSecondaryVertexCA15BJetTagsAk8PuppiJetsSoftDrop, process.pfBoostedDoubleSecondaryVertexCA15BJetTagsAk8PuppiJetsSoftDropSubjets, process.pfCombinedInclusiveSecondaryVertexV2BJetTagsAk8CHSJets, process.pfCombinedInclusiveSecondaryVertexV2BJetTagsAk8CHSJetsPruned, process.pfCombinedInclusiveSecondaryVertexV2BJetTagsAk8CHSJetsPrunedSubjets, process.pfCombinedInclusiveSecondaryVertexV2BJetTagsAk8CHSJetsSoftDrop, process.pfCombinedInclusiveSecondaryVertexV2BJetTagsAk8CHSJetsSoftDropSubjets, process.pfCombinedInclusiveSecondaryVertexV2BJetTagsAk8PuppiJetsFat, process.pfCombinedInclusiveSecondaryVertexV2BJetTagsAk8PuppiJetsSoftDrop, process.pfCombinedInclusiveSecondaryVertexV2BJetTagsAk8PuppiJetsSoftDropSubjets, process.pfCombinedMVAV2BJetTagsAk8CHSJets, process.pfCombinedMVAV2BJetTagsAk8CHSJetsPruned, process.pfCombinedMVAV2BJetTagsAk8CHSJetsPrunedSubjets, process.pfCombinedMVAV2BJetTagsAk8CHSJetsSoftDrop, process.pfCombinedMVAV2BJetTagsAk8CHSJetsSoftDropSubjets, process.pfCombinedMVAV2BJetTagsAk8PuppiJetsFat, process.pfCombinedMVAV2BJetTagsAk8PuppiJetsSoftDrop, process.pfCombinedMVAV2BJetTagsAk8PuppiJetsSoftDropSubjets, process.pfImpactParameterAK8TagInfosAk8CHSJets, process.pfImpactParameterAK8TagInfosAk8CHSJetsPruned, process.pfImpactParameterAK8TagInfosAk8CHSJetsPrunedSubjets, process.pfImpactParameterAK8TagInfosAk8CHSJetsSoftDrop, process.pfImpactParameterAK8TagInfosAk8CHSJetsSoftDropSubjets, process.pfImpactParameterAK8TagInfosAk8PuppiJetsFat, process.pfImpactParameterAK8TagInfosAk8PuppiJetsSoftDrop, process.pfImpactParameterAK8TagInfosAk8PuppiJetsSoftDropSubjets, process.pfImpactParameterCA15TagInfosAk8CHSJets, process.pfImpactParameterCA15TagInfosAk8CHSJetsPruned, process.pfImpactParameterCA15TagInfosAk8CHSJetsPrunedSubjets, process.pfImpactParameterCA15TagInfosAk8CHSJetsSoftDrop, process.pfImpactParameterCA15TagInfosAk8CHSJetsSoftDropSubjets, process.pfImpactParameterCA15TagInfosAk8PuppiJetsFat, process.pfImpactParameterCA15TagInfosAk8PuppiJetsSoftDrop, process.pfImpactParameterCA15TagInfosAk8PuppiJetsSoftDropSubjets, process.pfImpactParameterTagInfosAk8CHSJets, process.pfImpactParameterTagInfosAk8CHSJetsPruned, process.pfImpactParameterTagInfosAk8CHSJetsPrunedSubjets, process.pfImpactParameterTagInfosAk8CHSJetsSoftDrop, process.pfImpactParameterTagInfosAk8CHSJetsSoftDropSubjets, process.pfImpactParameterTagInfosAk8PuppiJetsFat, process.pfImpactParameterTagInfosAk8PuppiJetsSoftDrop, process.pfImpactParameterTagInfosAk8PuppiJetsSoftDropSubjets, process.pfInclusiveSecondaryVertexFinderAK8TagInfosAk8CHSJets, process.pfInclusiveSecondaryVertexFinderAK8TagInfosAk8CHSJetsPruned, process.pfInclusiveSecondaryVertexFinderAK8TagInfosAk8CHSJetsPrunedSubjets, process.pfInclusiveSecondaryVertexFinderAK8TagInfosAk8CHSJetsSoftDrop, process.pfInclusiveSecondaryVertexFinderAK8TagInfosAk8CHSJetsSoftDropSubjets, process.pfInclusiveSecondaryVertexFinderAK8TagInfosAk8PuppiJetsFat, process.pfInclusiveSecondaryVertexFinderAK8TagInfosAk8PuppiJetsSoftDrop, process.pfInclusiveSecondaryVertexFinderAK8TagInfosAk8PuppiJetsSoftDropSubjets, process.pfInclusiveSecondaryVertexFinderCA15TagInfosAk8CHSJets, process.pfInclusiveSecondaryVertexFinderCA15TagInfosAk8CHSJetsPruned, process.pfInclusiveSecondaryVertexFinderCA15TagInfosAk8CHSJetsPrunedSubjets, process.pfInclusiveSecondaryVertexFinderCA15TagInfosAk8CHSJetsSoftDrop, process.pfInclusiveSecondaryVertexFinderCA15TagInfosAk8CHSJetsSoftDropSubjets, process.pfInclusiveSecondaryVertexFinderCA15TagInfosAk8PuppiJetsFat, process.pfInclusiveSecondaryVertexFinderCA15TagInfosAk8PuppiJetsSoftDrop, process.pfInclusiveSecondaryVertexFinderCA15TagInfosAk8PuppiJetsSoftDropSubjets, process.pfInclusiveSecondaryVertexFinderTagInfosAk8CHSJets, process.pfInclusiveSecondaryVertexFinderTagInfosAk8CHSJetsPruned, process.pfInclusiveSecondaryVertexFinderTagInfosAk8CHSJetsPrunedSubjets, process.pfInclusiveSecondaryVertexFinderTagInfosAk8CHSJetsSoftDrop, process.pfInclusiveSecondaryVertexFinderTagInfosAk8CHSJetsSoftDropSubjets, process.pfInclusiveSecondaryVertexFinderTagInfosAk8PuppiJetsFat, process.pfInclusiveSecondaryVertexFinderTagInfosAk8PuppiJetsSoftDrop, process.pfInclusiveSecondaryVertexFinderTagInfosAk8PuppiJetsSoftDropSubjets, process.pfJetBProbabilityBJetTagsAk8CHSJets, process.pfJetBProbabilityBJetTagsAk8CHSJetsPruned, process.pfJetBProbabilityBJetTagsAk8CHSJetsPrunedSubjets, process.pfJetBProbabilityBJetTagsAk8CHSJetsSoftDrop, process.pfJetBProbabilityBJetTagsAk8CHSJetsSoftDropSubjets, process.pfJetBProbabilityBJetTagsAk8PuppiJetsFat, process.pfJetBProbabilityBJetTagsAk8PuppiJetsSoftDrop, process.pfJetBProbabilityBJetTagsAk8PuppiJetsSoftDropSubjets, process.pfJetProbabilityBJetTagsAk8CHSJets, process.pfJetProbabilityBJetTagsAk8CHSJetsPruned, process.pfJetProbabilityBJetTagsAk8CHSJetsPrunedSubjets, process.pfJetProbabilityBJetTagsAk8CHSJetsSoftDrop, process.pfJetProbabilityBJetTagsAk8CHSJetsSoftDropSubjets, process.pfJetProbabilityBJetTagsAk8PuppiJetsFat, process.pfJetProbabilityBJetTagsAk8PuppiJetsSoftDrop, process.pfJetProbabilityBJetTagsAk8PuppiJetsSoftDropSubjets, process.pfSecondaryVertexTagInfosAk8CHSJets, process.pfSecondaryVertexTagInfosAk8CHSJetsPruned, process.pfSecondaryVertexTagInfosAk8CHSJetsPrunedSubjets, process.pfSecondaryVertexTagInfosAk8CHSJetsSoftDrop, process.pfSecondaryVertexTagInfosAk8CHSJetsSoftDropSubjets, process.pfSecondaryVertexTagInfosAk8PuppiJetsFat, process.pfSecondaryVertexTagInfosAk8PuppiJetsSoftDrop, process.pfSecondaryVertexTagInfosAk8PuppiJetsSoftDropSubjets, process.pfSimpleSecondaryVertexHighEffBJetTagsAk8CHSJets, process.pfSimpleSecondaryVertexHighEffBJetTagsAk8CHSJetsPruned, process.pfSimpleSecondaryVertexHighEffBJetTagsAk8CHSJetsPrunedSubjets, process.pfSimpleSecondaryVertexHighEffBJetTagsAk8CHSJetsSoftDrop, process.pfSimpleSecondaryVertexHighEffBJetTagsAk8CHSJetsSoftDropSubjets, process.pfSimpleSecondaryVertexHighEffBJetTagsAk8PuppiJetsFat, process.pfSimpleSecondaryVertexHighEffBJetTagsAk8PuppiJetsSoftDrop, process.pfSimpleSecondaryVertexHighEffBJetTagsAk8PuppiJetsSoftDropSubjets, process.selectedPatJetsAK8PFCHS, process.selectedPatJetsAK8PFPUPPI, process.selectedPatJetsAk8CHSJets, process.selectedPatJetsAk8CHSJetsPruned, process.selectedPatJetsAk8CHSJetsPrunedSubjets, process.selectedPatJetsAk8CHSJetsSoftDrop, process.selectedPatJetsAk8CHSJetsSoftDropSubjets, process.selectedPatJetsAk8PuppiJetsFat, process.selectedPatJetsAk8PuppiJetsSoftDrop, process.selectedPatJetsAk8PuppiJetsSoftDropSubjets, process.softPFElectronsTagInfosAk8CHSJets, process.softPFElectronsTagInfosAk8CHSJetsPruned, process.softPFElectronsTagInfosAk8CHSJetsPrunedSubjets, process.softPFElectronsTagInfosAk8CHSJetsSoftDrop, process.softPFElectronsTagInfosAk8CHSJetsSoftDropSubjets, process.softPFElectronsTagInfosAk8PuppiJetsFat, process.softPFElectronsTagInfosAk8PuppiJetsSoftDrop, process.softPFElectronsTagInfosAk8PuppiJetsSoftDropSubjets, process.softPFMuonsTagInfosAk8CHSJets, process.softPFMuonsTagInfosAk8CHSJetsPruned, process.softPFMuonsTagInfosAk8CHSJetsPrunedSubjets, process.softPFMuonsTagInfosAk8CHSJetsSoftDrop, process.softPFMuonsTagInfosAk8CHSJetsSoftDropSubjets, process.softPFMuonsTagInfosAk8PuppiJetsFat, process.softPFMuonsTagInfosAk8PuppiJetsSoftDrop, process.softPFMuonsTagInfosAk8PuppiJetsSoftDropSubjets)
...
process.p = cms.Path(process.MyNtuple, cms.Task(process.NjettinessAk8CHS, process.NjettinessAk8Puppi, process.NjettinessAk8SoftDropCHS, process.NjettinessAk8SoftDropPuppi, process.ak8CHSJets, process.ak8CHSJetsFat, process.ak8CHSJetsPruned, process.ak8CHSJetsSoftDrop, process.ak8CHSJetsSoftDropforsub, process.ak8GenJets, process.ak8GenJetsFat, process.ak8GenJetsPruned, process.ak8GenJetsSoftDrop, process.ak8PuppiJets, process.ak8PuppiJetsFat, process.ak8PuppiJetsSoftDrop, process.ak8PuppiJetsSoftDropforsub, process.chs, process.packedGenParticlesForJetsNoNu, process.patJetsAk8CHSJetsPrunedPacked, process.patJetsAk8CHSJetsSoftDropPacked, process.patJetsAk8PuppiJetsSoftDropPacked, process.pfBoostedDoubleSVTagInfos, process.pfMet, process.prunedPrunedGenParticles, process.prunedTmp, process.puppi, process.slMETsCHS), process.patAlgosToolsTask)
